...
def main():
    ...
    client = core.CoreClient(username='gp', password='gp-admin', host='http://192.168.3.30:2999')
    ...
    train_input = TrainTSInput(
        data=train_data, target='regression', forecast_horizon=7, gap=0, algorithms=[AlgoTS.XGBoost],
