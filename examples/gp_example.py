...
def main():
    ...
    apikey = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoiNjAzNzVmMjJlMTJjYjUwMWFlNTRlMmJhIiwiaXNzIjoiZ3AtYmUiLCJzdWIiOiJhcGlrZXkiLCJhdWQiOiJjbGllbnQiLCJpYXQiOjE2MTQyNDE1NzAuNDQ3MTg1fQ.1dDQxGBDAI2lvL4cNUeuVOTCmi_olKCHtdYp52S4z8k"
    apikey = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoiNjAzNzZmZjllNDJkNjEwMjcxYzEyMDAxIiwiaXNzIjoiZ3AtYmUiLCJzdWIiOiJhcGlrZXkiLCJhdWQiOiJjbGllbnQiLCJpYXQiOjE2MTQyNDU4ODEuODAxNTkzfQ.-vqqe7a0bqp3L2xbH_Uq01lJwhDCSF9HNsjeBxytLzw"
    client = core.GPClient(apikey=apikey, host='http://192.168.2.6:1815')
