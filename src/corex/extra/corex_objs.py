...
"""
import json
from corex.extra.decorators import corex_obj
...
class TimeSeriesSplit(CoreXOBJ):
...
class ModelBuildControl(CoreXOBJ):
    """Model build control"""
    @classmethod
...
class GeneticAlgorithmParams(CoreXOBJ):
...
class TrainAutoTSBody(CoreXOBJ):
...
class PredictBodyTSModel(CoreXOBJ):
