...
def show_model_attr(metric, score_types, exp):
    ...
    Args:
        metric(lst): List of str indicates metrics ['mse', 'mae'...].
            Informations to show in chart.
        score_types(lst): List of str indicates score_type ['cv_averages',
            'validation'...]. Informations to show in chart.
        exp(class:`Experiemnt <Job>`): The experiment that want to show its
            models attributes.
    Returns:
